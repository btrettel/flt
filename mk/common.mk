...
src$(DIR_SEP)debug.$(OBJEXT): src$(DIR_SEP)revision.f90

src$(DIR_SEP)release.$(OBJEXT): src$(DIR_SEP)revision.f90

src$(DIR_SEP)units.$(OBJEXT): src$(DIR_SEP)prec.$(OBJEXT)

# Additional dependencies beyond the autogenerated dependencies.
checks.nml: test_assert_false$(BINEXT) test_assert_dimension_false_1$(BINEXT) test_assert_dimension_false_2$(BINEXT) test_assert_dimension_false_3$(BINEXT)
